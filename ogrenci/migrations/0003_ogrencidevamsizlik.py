...
class Migration(migrations.Migration):
    dependencies = [
        ("ogrenci", "0002_alter_ogrenci_adi_alter_ogrenci_soyadi"),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tarih",
                    models.DateField(default=django.utils.timezone.localdate, verbose_name="Tarih"),
                ),
                ("ders_saati", models.IntegerField(verbose_name="Ders Saati")),
                ("ders_adi", models.CharField(max_length=100, verbose_name="Ders Adı")),
                (
                    "ogretmen_adi",
                    models.CharField(max_length=100, verbose_name="Öğretmen"),
                ),
                (
                    "aciklama",
                    models.CharField(
