...
path("alanlar/", views.alan_listesi, name="secmeli_alan_listesi"),
    ...
    path("ders-dagilimi/", views.ders_dagilimi_listesi, name="secmeli_ders_dagilimi_listesi"),
    path("ders-dagilimi/alan/<int:gelecek_sinif>/<int:alan_pk>/<int:sube_no>/", views.ders_dagilimi_alan_detay, name="secmeli_ders_dagilimi_alan_detay"),
    path("ders-dagilimi/sube/<int:mevcut_sinif>/<str:sube>/", views.ders_dagilimi_sube_detay, name="secmeli_ders_dagilimi_sube_detay"),
    path("ogretmen-yuku/", views.ogretmen_yuku_raporu, name="secmeli_ogretmen_yuku_raporu"),
